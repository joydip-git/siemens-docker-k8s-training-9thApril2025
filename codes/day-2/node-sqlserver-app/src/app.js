...
// const CONNECTION_STRING = 'server=localhost\\sqlexpress,1433;database=pmsdb;user id=sa;password=sqlserver2024;TrustServerCertificate=True'
// const CONNECTION_STRING = 'server=.\\sqlexpress,1433;database=pmsdb;user id=sa;password=sqlserver2024;TrustServerCertificate=True'
// const CONNECTION_STRING = 'server=127.0.0.1\\sqlexpress,1433;database=pmsdb;user id=sa;password=sqlserver2024;TrustServerCertificate=True'
