...
app.post('/signup', async (req, res) => {
  ...
  try {
    ...
    console.log(process.env.AUTH_SERVICE_SERVICE_HOST);
    // const hashedPW = await axios.get(`http://${process.env.AUTH_SERVICE_SERVICE_HOST}:3000/hashed-password/${password}`);
